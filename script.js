...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const showConfirmationMessage = () => {
        const uniqueId = generateUniqueId(); // Générer l'ID unique
        ...
        // Ajouter un écouteur pour recommencer
